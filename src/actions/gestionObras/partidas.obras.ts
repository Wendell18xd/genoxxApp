...
import {ValidaCierreObraRequest} from '../../infrastructure/interfaces/gestionObras/liquidarMateriales/liquiMateObra.request';
import {ValidaCierreObrasResponse} from '../../infrastructure/interfaces/gestionObras/liquidarMateriales/liquiMateObra.response';
import {GrabarPartidaObrasRequest} from '../../infrastructure/interfaces/gestionObras/liquidarPartidas/grabar.partida.obras.request';
import {GrabarPartidaObrasResponse} from '../../infrastructure/interfaces/gestionObras/liquidarPartidas/grabar.partida.obras.response';
import {PartidasObrasRequest} from '../../infrastructure/interfaces/gestionObras/liquidarPartidas/partidas.obras.request';
import {PartidasObrasResponse} from '../../infrastructure/interfaces/gestionObras/liquidarPartidas/partidas.obras.response';
